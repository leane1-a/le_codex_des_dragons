class DragonsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to dragons_path, status: :see_other, notice: "Dragon was successfully destroyed." }
  ...
  private
    ...
    def set_dragon
      @dragon = Dragon.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def dragon_params
      params.expect(dragon: [ :name, :universe_id, :size, :description, :image ])
    end
end
